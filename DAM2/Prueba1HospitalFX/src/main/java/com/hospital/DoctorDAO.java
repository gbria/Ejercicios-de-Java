    ...
    public static boolean updateDoctor(Doctor doctor) {
        ...
        try {
            ...
            sql = "UPDATE Doctor SET" +
                    " firstname = '" + doctor.getFirstName().replaceAll("'", "@") + "'," +
                    "lastname = '" + doctor.getLastName().replaceAll("'", "@") + "'," +
                    "speciality = '" + doctor.getSpeciality().replaceAll("'", "@") + "'," +
                    "email = '" + doctor.getEmail().replaceAll("'", "@") + "'," +
                    "timetable = '" + doctor.getTimetable().replaceAll("'", "@") + "'," +
                    "extrahour = '" + doctor.getExtraHour() + "'," +
                    "phone = " + doctor.getPhone()  +
                    " WHERE dniDoctor = '" + doctor.getDni().replaceAll("'","@") + "';";

    ...
    public static boolean updateAppointment(Appointment appointment) {
        ...
        try {
            ...
            sql = "UPDATE Appointment SET " +
                    "date = '" + appointment.getDate().replaceAll("'", "@") + "', " +
                    "time = '" + appointment.getTime().replaceAll("'", "@") + "', " +
                    "dnipatient = '" + appointment.getPatient().getDni().replaceAll("'", "@") + "', " +
                    "dnidoctor = '" + appointment.getDoctor().getDni().replaceAll("'", "@") + "', " +
                    "dninurse = '" + appointment.getNurse().getDni().replaceAll("'", "@") + "', " +

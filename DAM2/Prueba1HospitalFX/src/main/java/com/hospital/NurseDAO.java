    ...
    public static boolean updateNurse(Nurse nurse) {
        ...
        try {
            ...
            sql = "UPDATE Nurse SET" +
                    " firstname = '" + nurse.getFirstName().replaceAll("'", "@") + "'," +
                    "lastname = '" + nurse.getLastName().replaceAll("'", "@") + "'," +
                    "email = '" + nurse.getEmail().replaceAll("'", "@") + "'," +
                    "timetable = '" + nurse.getTimeTable().replaceAll("'", "@") + "'," +
                    "phone = " + nurse.getPhone()  +
                    " WHERE dniNurse = '" + nurse.getDni().replaceAll("'","@") + "';";

...
/**
 * Creeu un programa que multipliqui dues matrius seguint les instruccions seg¨uents:
 */
...
public class Ex7 {
    public static void main(String[] args) {
        ...
        //Método que multiplica las dos matrices
        int matrizTotal[][] = multiplicarMatrices(matriz1, matriz2, rows, cols);
    ...
    private static int[][] multiplicarMatrices(int[][] matriz1, int[][] matriz2, int rows, int cols) {
